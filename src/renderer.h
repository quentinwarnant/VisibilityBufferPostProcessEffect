...
private:
    ...
    std::array<Microsoft::WRL::ComPtr<ID3D12Resource>, 3> m_effectTileLists;
    std::array<Microsoft::WRL::ComPtr<ID3D12Resource>, 3> m_indirectArgs;
    ...
    std::array<Microsoft::WRL::ComPtr<ID3D12PipelineState>, 3> m_classifyEffectPsos;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> m_finalizeIndirectPso;
    std::array<Microsoft::WRL::ComPtr<ID3D12PipelineState>, 3> m_effectPsos;
